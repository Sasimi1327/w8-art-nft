...
$(document).ready(function () {
  ...
  $(".search-btn").on("click", function (e) {
    if ($(this).hasClass("collapsed")) {
      ...
      $(this).closest(".search-form").removeClass("position-absolute position-lg-relative right-0 zindex-0 w-100");
      $(this).closest(".search-form").find("#navbarSearch").removeClass("show");
      $(this).closest(".search-form").find(".return-btn").removeClass("d-block").addClass("d-none");
    } else {
      console.log("close->open"); //close->open

      if ($(window).width() < 992) {
        console.log("lessThan-992");
        $(this).closest(".search-form").siblings().find(".fa-solid").removeClass("fa-xmark").addClass("fa-bars");
        $(this).closest(".search-form").siblings().addClass("collapsed").siblings().removeClass("show");
        $(this).closest(".search-form").addClass("position-absolute position-lg-relative right-0 zindex-0 w-100");
        $(this).closest(".search-form").find("#navbarSearch").addClass("show");
        $(this).closest(".search-form").find(".return-btn").removeClass("d-none").addClass("d-block");
      }
    }
  });
